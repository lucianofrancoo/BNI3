...
Examples:
  ...
  python3 BNI3_Evaluate_rules.py -i rules_by_gene.tsv -m binarized_matrix.tsv -v
  
  # Limit to top 5 rules per gene (instead of all tied for best)
  python3 BNI3_Evaluate_rules.py -i rules_by_gene.tsv --top-n 5 -v
  
  # Limit to 500 combinations max (instead of all)
  python3 BNI3_Evaluate_rules.py -i rules_by_gene.tsv --max-combos 500 -v
  
  # Both limits combined
  python3 BNI3_Evaluate_rules.py -i rules_by_gene.tsv --top-n 3 --max-combos 200 -v
  
  # Custom output directory
  python3 BNI3_Evaluate_rules.py -i rules_by_gene.tsv -o /path/to/results.tsv -v
  
  # Use custom score column for ranking
  python3 BNI3_Evaluate_rules.py -i rules_by_gene.tsv --score-col MSE -v
