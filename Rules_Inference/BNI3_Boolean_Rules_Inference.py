...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  # Basic usage with automatic MLP configuration
...
Notes:
  ...
  - Analysis creates rules_by_gene.tsv in the output directory
    ...
    parser.add_argument('--version', action='version', version='GEP Boolean Network Inference v2.0 (Auto-MLP)')
