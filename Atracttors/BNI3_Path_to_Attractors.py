...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python3 BNI3_Path_to_Attractor.py -a attractors.tsv -r selected_rules.tsv -s "1010110010110"
  python3 BNI3_Path_to_Attractor.py -a attractors.tsv -r selected_rules.tsv -s "ABF3,NRT2_1,TGA4" -v
  python3 BNI3_Path_to_Attractor.py -a attractors.tsv -r rules_by_gene.tsv -s "0000000000000" -o output/

Input Files:
  Preferred: selected_rules.tsv (generated by BNI3_Attractors.py)
...
Notes:
  - Requires attractors.tsv from BNI3_Attractors.py
  - Requires rules file from BNI3_Analyze_results.py  
  - Uses same rule selection criteria as BNI3_Attractors.py
  ...
  - Detects cycles that don't match known attractors
    ...
    required.add_argument('-r', '--rules_file', type=str, required=True,
                     help='Input rules file: selected_rules.tsv (from BNI3_Attractors.py) or full rules table')
